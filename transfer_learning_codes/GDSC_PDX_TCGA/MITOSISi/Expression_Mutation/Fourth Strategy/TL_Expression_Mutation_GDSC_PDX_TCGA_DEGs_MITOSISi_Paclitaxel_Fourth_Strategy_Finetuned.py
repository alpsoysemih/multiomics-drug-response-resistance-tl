...
load_models_from = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/MITOSISi/save_models/GDSC_PDX_TCGA_Fourth_Strategy/Expression_Mutation/"
save_finetuned_models_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/MITOSISi/save_models/GDSC_PDX_TCGA_Fourth_Strategy/Expression_Mutation/Fourth_Strategy_Finetuned_Models/"
save_figures_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/MITOSISi/save_models/GDSC_PDX_TCGA_Fourth_Strategy/Expression_Mutation/AUC and Cost Plots (Finetuned)/"
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCEv2.values, Y):
        ...
        AutoencoderE = torch.load(
            load_models_from + 'Exprs_MITOSISi_Expression_Mutation_GDSC_PDX_TCGA_Paclitaxel_Fourth_Strategy.pt')
        AutoencoderM = torch.load(
            load_models_from + 'Mut_MITOSISi_Expression_Mutation_GDSC_PDX_TCGA_Paclitaxel_Fourth_Strategy.pt')
        Clas = torch.load(
            load_models_from + 'Class_MITOSISi_Expression_Mutation_GDSC_PDX_TCGA_Paclitaxel_Fourth_Strategy.pt')
    ...
    torch.save(AutoencoderE,
               f"Exprs_MITOSISi_Expression_Mutation_GDSC_PDX_TCGA_Paclitaxel_Fourth_Strategy_Finetuned_{iters + 1}.pt")
    torch.save(
        AutoencoderM, f"Mut_MITOSISi_Expression_Mutation_GDSC_PDX_TCGA_Paclitaxel_Fourth_Strategy_Finetuned_{iters + 1}.pt")
    torch.save(Clas, f'Class_MITOSISi_Expression_Mutation_GDSC_PDX_TCGA_Paclitaxel_Fourth_Strategy_Finetuned_{iters + 1}.pt')
