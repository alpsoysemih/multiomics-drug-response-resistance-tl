...
load_models_from = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/EGFRi/save_models/GDSC_PDX_TCGA_Third_Strategy/Expression_Mutation/"
save_finetuned_models_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/EGFRi/save_models/GDSC_PDX_TCGA_Third_Strategy/Expression_Mutation/Third_Strategy_Finetuned_Models/"
save_figures_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/EGFRi/save_models/GDSC_PDX_TCGA_Third_Strategy/Expression_Mutation/AUC and Cost Plots (Finetuned)/"
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCEv2.values, Y):
        ...
        AutoencoderE = torch.load(
            load_models_from + 'Exprs_EGFRi_Expression_Mutation_GDSC_PDX_TCGA_Cetuximab_Third_Strategy.pt')
        AutoencoderM = torch.load(
            load_models_from + 'Mut_EGFRi_Expression_Mutation_GDSC_PDX_TCGA_Cetuximab_Third_Strategy.pt')
        Clas = torch.load(
            load_models_from + 'Class_EGFRi_Expression_Mutation_GDSC_PDX_TCGA_Cetuximab_Third_Strategy.pt')
    ...
    torch.save(AutoencoderE,
               f"Exprs_EGFRi_Expression_Mutation_GDSC_PDX_TCGA_Cetuximab_Third_Strategy_Finetuned_{iters + 1}.pt")
    torch.save(
        AutoencoderM, f"Mut_EGFRi_Expression_Mutation_GDSC_PDX_TCGA_Cetuximab_Third_Strategy_Finetuned_{iters + 1}.pt")
    torch.save(Clas, f'Class_EGFRi_Expression_Mutation_GDSC_PDX_TCGA_Cetuximab_Third_Strategy_Finetuned_{iters + 1}.pt')
