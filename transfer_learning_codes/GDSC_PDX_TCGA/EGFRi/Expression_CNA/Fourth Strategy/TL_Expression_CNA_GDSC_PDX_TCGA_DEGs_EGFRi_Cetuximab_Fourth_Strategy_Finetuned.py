...
load_models_from = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/EGFRi/save_models/GDSC_PDX_TCGA_Fourth_Strategy/Expression_CNA/"
save_finetuned_models_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/EGFRi/save_models/GDSC_PDX_TCGA_Fourth_Strategy/Expression_CNA/Fourth_Strategy_Finetuned_Models/"
save_figures_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/EGFRi/save_models/GDSC_PDX_TCGA/Expression_CNA_Fourth_Strategy/AUC and Cost Plots (Finetuned)/"
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCEv2.values, Y):
        ...
        AutoencoderE = torch.load(
            load_models_from + 'Exprs_EGFRi_Expression_CNA_GDSC_PDX_TCGA_Cetuximab_Fourth_Strategy.pt')
        AutoencoderC = torch.load(
            load_models_from + 'CNA_EGFRi_Expression_CNA_GDSC_PDX_TCGA_Cetuximab_Fourth_Strategy.pt')
        Clas = torch.load(
            load_models_from + 'Class_EGFRi_Expression_CNA_GDSC_PDX_TCGA_Cetuximab_Fourth_Strategy.pt')
    ...
    torch.save(AutoencoderE,
               f"Exprs_EGFRi_Expression_CNA_GDSC_PDX_TCGA_Cetuximab_Fourth_Strategy_Finetuned_{iters + 1}.pt")
    torch.save(
        AutoencoderC, f"CNA_EGFRi_Expression_CNA_GDSC_PDX_TCGA_Cetuximab_Fourth_Strategy_Finetuned_{iters + 1}.pt")
    torch.save(Clas, f'Class_EGFRi_Expression_CNA_GDSC_PDX_TCGA_Cetuximab_Fourth_Strategy_Finetuned_{iters + 1}.pt')
