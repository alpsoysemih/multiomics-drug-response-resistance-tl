...
torch.save(
    AutoencoderE, "Exprs_DNA_REPi_Expression_Mutation_CNA_GDSC_PDX_TCGA_Gemcitabine_Second_Strategy.pt")
torch.save(
    AutoencoderM, "Mut_DNA_REPi_Expression_Mutation_CNA_GDSC_PDX_TCGA_Gemcitabine_Second_Strategy.pt")
torch.save(
    AutoencoderC, "CNA_DNA_REPi_Expression_Mutation_CNA_GDSC_PDX_TCGA_Gemcitabine_Second_Strategy.pt")
torch.save(Clas, 'Class_DNA_REPi_Expression_Mutation_CNA_GDSC_PDX_TCGA_Gemcitabine_Second_Strategy.pt')
