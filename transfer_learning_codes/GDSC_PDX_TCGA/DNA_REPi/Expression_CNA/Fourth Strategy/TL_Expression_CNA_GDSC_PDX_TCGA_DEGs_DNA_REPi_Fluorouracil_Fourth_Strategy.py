...
save_models_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/DNA_REPi/save_models/GDSC_PDX_TCGA_Fourth_Strategy/Expression_CNA/"
save_results_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/DNA_REPi/save_models/GDSC_PDX_TCGA_Fourth_Strategy/Expression_CNA/AUC and Cost Plots/"
...
# convert GDSC expression, CNA, and response indices to string
...
torch.save(AutoencoderE,
           "Exprs_DNA_REPi_Expression_CNA_GDSC_PDX_TCGA_Fluorouracil_Fourth_Strategy.pt")
torch.save(AutoencoderC,
           "CNA_DNA_REPi_Expression_CNA_GDSC_PDX_TCGA_Fluorouracil_Fourth_Strategy.pt")
torch.save(
    Clas, 'Class_DNA_REPi_Expression_CNA_GDSC_PDX_TCGA_Fluorouracil_Fourth_Strategy.pt')
