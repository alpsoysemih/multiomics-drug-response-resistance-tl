...
save_models_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/CYTOi/save_models/GDSC_PDX_TCGA_Second_Strategy/Expression_CNA/"
save_results_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/CYTOi/save_models/GDSC_PDX_TCGA_Second_Strategy/Expression_CNA/AUC and Cost Plots/"
...
print(f"PDX # of common samples and genes for Cetuximab (Expression): {PDXEpaclitaxel.shape}")
print(f"PDX # of common samples and genes for Cetuximab (CNA): {PDXCpaclitaxel.shape}\n")

print(f"TCGA # of common samples and genes for Cetuximab (Expression): {TCGAEpaclitaxel.shape}")
print(f"TCGA # of common samples and genes for Cetuximab (CNA): {TCGACpaclitaxel.shape}\n")
...
torch.save(AutoencoderE,
           "Exprs_CYTOi_Expression_CNA_GDSC_PDX_TCGA_Paclitaxel_Second_Strategy.pt")
torch.save(AutoencoderC,
           "CNA_CYTOi_Expression_CNA_GDSC_PDX_TCGA_Paclitaxel_Second_Strategy.pt")
torch.save(
    Clas, 'Class_CYTOi_Expression_CNA_GDSC_PDX_TCGA_Paclitaxel_Second_Strategy.pt')
