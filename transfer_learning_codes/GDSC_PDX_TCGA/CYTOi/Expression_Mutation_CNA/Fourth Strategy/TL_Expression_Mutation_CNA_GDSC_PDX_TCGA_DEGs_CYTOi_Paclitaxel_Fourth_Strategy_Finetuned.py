...
load_models_from = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/CYTOi/save_models/GDSC_PDX_TCGA_Fourth_Strategy/Expression_Mutation_CNA/"
save_finetuned_models_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/CYTOi/save_models/GDSC_PDX_TCGA_Fourth_Strategy/Expression_Mutation_CNA/Fourth_Strategy_Finetuned_Models/"
save_figures_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/CYTOi/save_models/GDSC_PDX_TCGA_Fourth_Strategy/Expression_Mutation_CNA/AUC and Cost Plots (Finetuned)/"
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCEv2.values, Y):
        ...
        AutoencoderE = torch.load(
            load_models_from + 'Exprs_CYTOi_Expression_Mutation_CNA_GDSC_PDX_TCGA_Paclitaxel_Fourth_Strategy.pt')
        AutoencoderM = torch.load(
            load_models_from + 'Mut_CYTOi_Expression_Mutation_CNA_GDSC_PDX_TCGA_Paclitaxel_Fourth_Strategy.pt')
        AutoencoderC = torch.load(
            load_models_from + 'CNA_CYTOi_Expression_Mutation_CNA_GDSC_PDX_TCGA_Paclitaxel_Fourth_Strategy.pt')
        Clas = torch.load(
            load_models_from + 'Class_CYTOi_Expression_Mutation_CNA_GDSC_PDX_TCGA_Paclitaxel_Fourth_Strategy.pt')
    ...
    torch.save(AutoencoderE,
               f"Exprs_CYTOi_Expression_Mutation_CNA_GDSC_PDX_TCGA_Paclitaxel_Fourth_Strategy_Finetuned_{iters + 1}.pt")
    torch.save(
        AutoencoderM, f"Mut_CYTOi_Expression_Mutation_CNA_GDSC_PDX_TCGA_Paclitaxel_Fourth_Strategy_Finetuned_{iters + 1}.pt")
    torch.save(
        AutoencoderC, f"CNA_CYTOi_Expression_Mutation_CNA_GDSC_PDX_TCGA_Paclitaxel_Fourth_Strategy_Finetuned_{iters + 1}.pt")    
    torch.save(Clas, f'Class_CYTOi_Expression_Mutation_CNA_GDSC_PDX_TCGA_Paclitaxel_Fourth_Strategy_Finetuned_{iters + 1}.pt')
