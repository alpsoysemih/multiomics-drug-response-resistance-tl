...
save_results_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/MITOSISi/save_models/GDSC_PDX/Expression_Mutation_CNA/Cost and AUC Plots/"
...
torch.save(AutoencoderE,
           "Exprs_Paclitaxel_GDSC_PDX_MITOSISi_Expression_Mutation_CNA.pt")
torch.save(AutoencoderM,
           "Mut_Paclitaxel_GDSC_PDX_MITOSISi_Expression_Mutation_CNA.pt")
torch.save(AutoencoderC,
           "CNA_Paclitaxel_GDSC_PDX_MITOSISi_Expression_Mutation_CNA.pt")
torch.save(
    Clas, 'Class_Paclitaxel_GDSC_PDX_MITOSISi_Expression_Mutation_CNA.pt')
