...
torch.save(AutoencoderE,
           "Exprs_Cetuximab_GDSC_PDX_EGFRi_Expression_Mutation_CNA.pt")
torch.save(AutoencoderM,
           "Mut_Cetuximab_GDSC_PDX_EGFRi_Expression_Mutation_CNA.pt")
torch.save(AutoencoderC,
           "CNA_Cetuximab_GDSC_PDX_EGFRi_Expression_Mutation_CNA.pt")
torch.save(
    Clas, 'Class_Cetuximab_GDSC_PDX_EGFRi_Expression_Mutation_CNA.pt')
