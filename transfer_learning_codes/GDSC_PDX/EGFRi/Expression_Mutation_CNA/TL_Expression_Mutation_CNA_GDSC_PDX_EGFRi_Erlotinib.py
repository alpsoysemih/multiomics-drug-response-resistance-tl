...
save_results_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/EGFRi/save_models/GDSC_PDX/Expression_Mutation_CNA/Cost and AUC Plots/"
...
PDXMerlotinib  = pd.read_csv("PDX_mutations.Erlotinib.tsv",
                      sep="\t", index_col=0, decimal=",")
...
torch.save(AutoencoderE,
           "Exprs_Erlotinib_GDSC_PDX_EGFRi_Expression_Mutation_CNA.pt")
torch.save(AutoencoderM,
           "Mut_Erlotinib_GDSC_PDX_EGFRi_Expression_Mutation_CNA.pt")
torch.save(AutoencoderC,
           "CNA_Erlotinib_GDSC_PDX_EGFRi_Expression_Mutation_CNA.pt")
torch.save(
    Clas, 'Class_Erlotinib_GDSC_PDX_EGFRi_Expression_Mutation_CNA.pt')
