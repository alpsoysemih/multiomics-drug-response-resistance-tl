...
torch.save(AutoencoderE, "Exprs_Cetuximab_GDSC_PDX_EGFRi_Expression_CNA.pt")
torch.save(AutoencoderC, "CNA_Cetuximab_GDSC_PDX_EGFRi_Expression_CNA.pt")
torch.save(Clas, 'Class_Cetuximab_GDSC_PDX_EGFRi_Expression_CNA.pt')
