...
torch.save(
    AutoencoderE, "Exprs_Erlotinib_GDSC_PDX_EGFRi_Expression_Mutation.pt")
torch.save(AutoencoderM,
           "Mut_Erlotinib_GDSC_PDX_EGFRi_Expression_Mutation.pt")
torch.save(
    Clas, 'Class_Erlotinib_GDSC_PDX_EGFRi_Expression_Mutation.pt')
