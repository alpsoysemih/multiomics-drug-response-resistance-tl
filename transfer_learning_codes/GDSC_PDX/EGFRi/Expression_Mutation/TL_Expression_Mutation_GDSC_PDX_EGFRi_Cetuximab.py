...
save_results_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/EGFRi/save_models/GDSC_PDX/Expression_Mutation/AUC and Cost Plots/"
...
torch.save(
    AutoencoderE, "Exprs_Cetuximab_GDSC_PDX_EGFRi_Expression_Mutation.pt")
torch.save(AutoencoderM,
           "Mut_Cetuximab_GDSC_PDX_EGFRi_Expression_Mutation.pt")
torch.save(
    Clas, 'Class_Cetuximab_GDSC_PDX_EGFRi_Expression_Mutation.pt')
