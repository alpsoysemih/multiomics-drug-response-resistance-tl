...
save_models_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/DNA_REPi/save_models/GDSC_PDX/Expression_Mutation/"
save_finetuned_models_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/DNA_REPi/save_models/GDSC_PDX/Expression_Mutation/Finetuned_Models/"
save_results_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/DNA_REPi/save_models/GDSC_PDX/Expression_Mutation/AUC and Cost Plots (Finetuned)/"
...
# subset shared samples and genes in PDX expression and mutation datasets (5-Fluorouracil)
...
pdx_cohort = pd.read_excel(pdx_data_dir + "/nm.3954-S2.xlsx",
                              "PCT raw data")
pdx_cohort = pdx_cohort.loc[pdx_cohort["Treatment"] == "fluorouracil",]
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCEv2.values, Y):
        ...
        AutoencoderE = torch.load(
            save_models_to + 'Exprs_Fluorouracil_GDSC_PDX_DNA_REPi_Expression_Mutation.pt')
        AutoencoderM = torch.load(
            save_models_to + 'Mut_Fluorouracil_GDSC_PDX_DNA_REPi_Expression_Mutation.pt')
        Clas = torch.load(
            save_models_to + 'Class_Fluorouracil_GDSC_PDX_DNA_REPi_Expression_Mutation.pt')
        ...
        title = 'Cost 5-Fluorouracil iter = {}, fold = {}, mb_size = {},  h_dim[1,2] = ({},{}), \nlr[E,M] = ({}, {}), epoch = {}, rate[1,2,3] = ({},{},{}), wd = {}, lrCL = {}'.\
        ...
        title = 'AUC 5-Fluorouracil iter = {}, fold = {}, mb_size = {},  h_dim[1,2] = ({},{}), \nlr[E, M] = ({}, {}), epoch = {}, rate[1,2,3] = ({},{},{}), wd = {}, lrCL = {}'.\
            format(iters, k, mbs, hdm1, hdm2, lre, lrm,
                   epch, rate1, rate2, rate3, wd, lrCL)
    ...
    torch.save(AutoencoderE,
               f"Exprs_Fluorouracil_GDSC_PDX_DNA_REPi_Expression_Mutation_Finetuned_{iters + 1}.pt")
    torch.save(
        AutoencoderM, f"Mut_Fluorouracil_GDSC_PDX_DNA_REPi_Expression_Mutation_Finetuned_{iters + 1}.pt")
    torch.save(Clas, f'Class_Fluorouracil_GDSC_PDX_DNA_REPi_Expression_Mutation_Finetuned_{iters + 1}.pt')
