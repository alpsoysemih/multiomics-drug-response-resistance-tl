...
torch.save(AutoencoderE,
           "Exprs_Gemcitabine_GDSC_PDX_DNA_REPi_Expression_Mutation_CNA.pt")
torch.save(AutoencoderM,
           "Mut_Gemcitabine_GDSC_PDX_DNA_REPi_Expression_Mutation_CNA.pt")
torch.save(AutoencoderC,
           "CNA_Gemcitabine_GDSC_PDX_DNA_REPi_Expression_Mutation_CNA.pt")
torch.save(
    Clas, 'Class_Gemcitabine_GDSC_PDX_DNA_REPi_Expression_Mutation_CNA.pt')
