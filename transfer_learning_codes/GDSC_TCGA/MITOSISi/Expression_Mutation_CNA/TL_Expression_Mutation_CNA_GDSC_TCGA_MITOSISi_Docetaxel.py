...
torch.save(AutoencoderE,
           "Exprs_Docetaxel_GDSC_TCGA_MITOSISi_Expression_Mutation_CNA.pt.pt")
torch.save(AutoencoderM,
           "Mut_Docetaxel_GDSC_TCGA_MITOSISi_Expression_Mutation_CNA.pt.pt")
torch.save(AutoencoderC,
           "CNA_Docetaxel_GDSC_TCGA_MITOSISi_Expression_Mutation_CNA.pt.pt")
torch.save(
    Clas, 'Class_Docetaxel_GDSC_TCGA_MITOSISi_Expression_Mutation_CNA.pt.pt')
