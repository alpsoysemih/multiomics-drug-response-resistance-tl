...
save_results_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/MITOSISi/save_models/GDSC_TCGA/Expression_Mutation/AUC and Cost Plots/"
...
torch.save(
    AutoencoderE, "Exprs_Docetaxel_GDSC_TCGA_MITOSISi_Expression_Mutation.pt")
torch.save(AutoencoderM,
           "Mut_Docetaxel_GDSC_TCGA_MITOSISi_Expression_Mutation.pt")
torch.save(
    Clas, 'Class_Docetaxel_GDSC_TCGA_MITOSISi_Expression_Mutation.pt')
