...
torch.save(
    AutoencoderE, "Exprs_Paclitaxel_GDSC_TCGA_MITOSISi_Expression_Mutation.pt")
torch.save(AutoencoderM,
           "Mut_Paclitaxel_GDSC_TCGA_MITOSISi_Expression_Mutation.pt")
torch.save(
    Clas, 'Class_Paclitaxel_GDSC_TCGA_MITOSISi_Expression_Mutation.pt')
