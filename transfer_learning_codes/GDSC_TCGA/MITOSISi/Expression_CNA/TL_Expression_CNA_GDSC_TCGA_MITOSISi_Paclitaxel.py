...
torch.save(AutoencoderE,
           "Exprs_Paclitaxel_GDSC_TCGA_MITOSISi_Expression_CNA.pt")
torch.save(
    AutoencoderC, "CNA_Paclitaxel_GDSC_TCGA_MITOSISi_Expression_CNA.pt")
torch.save(
    Clas, 'Class_Paclitaxel_GDSC_TCGA_MITOSISi_Expression_CNA.pt')
