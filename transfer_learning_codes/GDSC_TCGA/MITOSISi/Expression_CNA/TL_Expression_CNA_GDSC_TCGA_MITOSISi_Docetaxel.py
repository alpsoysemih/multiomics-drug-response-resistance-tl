...
save_results_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/MITOSISi/save_models/GDSC_TCGA/Expression_CNA/AUC and Cost Plots/"
...
torch.save(AutoencoderE,
           "Exprs_Docetaxel_GDSC_TCGA_MITOSISi_Expression_CNA.pt")
torch.save(
    AutoencoderC, "CNA_Docetaxel_GDSC_TCGA_MITOSISi_Expression_CNA.pt")
torch.save(
    Clas, 'Class_Docetaxel_GDSC_TCGA_MITOSISi_Expression_CNA.pt')
