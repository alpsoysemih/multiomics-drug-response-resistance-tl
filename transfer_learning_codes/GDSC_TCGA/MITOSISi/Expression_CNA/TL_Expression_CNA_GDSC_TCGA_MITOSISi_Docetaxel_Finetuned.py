...
save_models_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/MITOSISi/save_models/GDSC_TCGA/Expression_CNA/"
save_finetuned_models_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/MITOSISi/save_models/GDSC_TCGA/Expression_CNA/Finetuned_Models/"
save_results_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/MITOSISi/save_models/GDSC_TCGA/Expression_CNA/AUC and Cost Plots (Finetuned)/"
...
# fill NA values in GDSC CNA dataset (MITOSISi)
...
# select shared samples between GDSC expression, mutation and CNA datasets (MITOSISi)
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCEv2.values, Y):
        ...
        AutoencoderE = torch.load(
            save_models_to + 'Exprs_Docetaxel_GDSC_TCGA_MITOSISi_Expression_CNA.pt')
        AutoencoderC = torch.load(
            save_models_to + 'CNA_Docetaxel_GDSC_TCGA_MITOSISi_Expression_CNA.pt')
        Clas = torch.load(
            save_models_to + 'Class_Docetaxel_GDSC_TCGA_MITOSISi_Expression_CNA.pt')
    ...
    torch.save(AutoencoderE,
               f"Exprs_Docetaxel_GDSC_TCGA_MITOSISi_Expression_CNA_Finetuned_{iters + 1}.pt")
    torch.save(
        AutoencoderC, f"CNA_Docetaxel_GDSC_TCGA_MITOSISi_Expression_CNA_Finetuned_{iters + 1}.pt")
    torch.save(Clas, f'Class_Docetaxel_GDSC_TCGA_MITOSISi_Expression_CNA_Finetuned_{iters + 1}.pt')
