...
torch.save(AutoencoderE,
           "Exprs_Doxorubicin_GDSC_TCGA_DNA_REPi_Expression_Mutation.pt")
torch.save(AutoencoderM,
           "Mut_Doxorubicin_GDSC_TCGA_DNA_REPi_Expression_Mutation.pt")
torch.save(
    Clas, 'Class_Doxorubicin_GDSC_TCGA_DNA_REPi_Expression_Mutation.pt')
