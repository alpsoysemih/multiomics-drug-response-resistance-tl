...
torch.save(AutoencoderE,
           "Exprs_Cisplatin_GDSC_TCGA_DNA_REPi_Expression_Mutation.pt")
torch.save(AutoencoderM,
           "Mut_Cisplatin_GDSC_TCGA_DNA_REPi_Expression_Mutation.pt")
torch.save(
    Clas, 'Class_Cisplatin_GDSC_TCGA_DNA_REPi_Expression_Mutation.pt')
