...
save_results_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/DNA_REPi/save_models/GDSC_TCGA/Expression_Mutation/AUC and Cost Plots/"
...
torch.save(AutoencoderE,
           "Exprs_Fluorouracil_GDSC_TCGA_DNA_REPi_Expression_Mutation.pt")
torch.save(AutoencoderM,
           "Mut_Fluorouracil_GDSC_TCGA_DNA_REPi_Expression_Mutation.pt")
torch.save(
    Clas, 'Class_Fluorouracil_GDSC_TCGA_DNA_REPi_Expression_Mutation.pt')
