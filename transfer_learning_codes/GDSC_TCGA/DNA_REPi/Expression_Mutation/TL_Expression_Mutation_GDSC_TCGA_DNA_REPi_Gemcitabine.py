...
torch.save(AutoencoderE,
           "Exprs_Gemcitabine_GDSC_TCGA_DNA_REPi_Expression_Mutation.pt")
torch.save(AutoencoderM,
           "Mut_Gemcitabine_GDSC_TCGA_DNA_REPi_Expression_Mutation.pt")
torch.save(
    Clas, 'Class_Gemcitabine_GDSC_TCGA_DNA_REPi_Expression_Mutation.pt')
