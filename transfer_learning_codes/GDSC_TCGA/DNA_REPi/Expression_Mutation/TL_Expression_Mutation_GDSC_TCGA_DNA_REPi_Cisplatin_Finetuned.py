...
# subset shared samples and genes in TCGA expression and mutation datasets (Cisplatin)
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCEv2.values, Y):
        ...
        AutoencoderE = torch.load(
            save_models_to + 'Exprs_Cisplatin_GDSC_TCGA_DNA_REPi_Expression_Mutation.pt')
        AutoencoderM = torch.load(
            save_models_to + 'Mut_Cisplatin_GDSC_TCGA_DNA_REPi_Expression_Mutation.pt')
        Clas = torch.load(
            save_models_to + 'Class_Cisplatin_GDSC_TCGA_DNA_REPi_Expression_Mutation.pt')
        ...
        title = 'Cost Cisplatin iter = {}, fold = {}, mb_size = {},  h_dim[1,2] = ({},{}), \nlr[E,M] = ({}, {}), epoch = {}, rate[1,2,3] = ({},{},{}), wd = {}, lrCL = {}'.\
        ...
        title = 'AUC Cisplatin iter = {}, fold = {}, mb_size = {},  h_dim[1,2] = ({},{}), \nlr[E, M] = ({}, {}), epoch = {}, rate[1,2,3] = ({},{},{}), wd = {}, lrCL = {}'.\
            format(iters, k, mbs, hdm1, hdm2, lre, lrm,
                   epch, rate1, rate2, rate3, wd, lrCL)
    ...
    torch.save(AutoencoderE,
               f"Exprs_Cisplatin_GDSC_TCGA_DNA_REPi_Expression_Mutation_Finetuned_{iters + 1}.pt")
    torch.save(
        AutoencoderM, f"Mut_Cisplatin_GDSC_TCGA_DNA_REPi_Expression_Mutation_Finetuned_{iters + 1}.pt")
    torch.save(Clas, f'Class_Cisplatin_GDSC_TCGA_DNA_REPi_Expression_Mutation_Finetuned_{iters + 1}.pt')
