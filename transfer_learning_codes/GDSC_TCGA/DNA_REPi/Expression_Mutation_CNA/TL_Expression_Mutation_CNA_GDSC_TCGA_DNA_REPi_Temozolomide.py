...
torch.save(AutoencoderE, "Exprs_Temozolomide_GDSC_TCGA_DNA_REPi_Expression_Mutation_CNA.pt")
torch.save(AutoencoderM, "Mut_Temozolomide_GDSC_TCGA_DNA_REPi_Expression_Mutation_CNA.pt")
torch.save(AutoencoderC, "CNA_Temozolomide_GDSC_TCGA_DNA_REPi_Expression_Mutation_CNA.pt")
torch.save(Clas, 'Class_Temozolomide_GDSC_TCGA_DNA_REPi_Expression_Mutation_CNA.pt')
