...
torch.save(AutoencoderE, "Exprs_Fluorouracil_GDSC_TCGA_DNA_REPi_Expression_Mutation_CNA.pt")
torch.save(AutoencoderM, "Mut_Fluorouracil_GDSC_TCGA_DNA_REPi_Expression_Mutation_CNA.pt")
torch.save(AutoencoderC, "CNA_Fluorouracil_GDSC_TCGA_DNA_REPi_Expression_Mutation_CNA.pt")
torch.save(Clas, 'Class_Fluorouracil_GDSC_TCGA_DNA_REPi_Expression_Mutation_CNA.pt')
