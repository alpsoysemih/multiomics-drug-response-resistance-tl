...
torch.save(AutoencoderE,
           "Exprs_Cisplatin_GDSC_TCGA_DNA_REPi_Expression_CNA.pt")
torch.save(AutoencoderC,
           "CNA_Cisplatin_GDSC_TCGA_DNA_REPi_Expression_CNA.pt")
torch.save(
    Clas, 'Class_Cisplatin_GDSC_TCGA_DNA_REPi_Expression_CNA.pt')
