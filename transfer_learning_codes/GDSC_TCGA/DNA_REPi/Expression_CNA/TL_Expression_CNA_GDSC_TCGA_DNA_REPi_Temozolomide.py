...
save_results_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/DNA_REPi/save_models/GDSC_TCGA/Expression_CNA/AUC and Cost Plots/"
...
torch.save(AutoencoderE,
           "Exprs_Temozolomide_GDSC_TCGA_DNA_REPi_Expression_CNA.pt")
torch.save(AutoencoderC,
           "CNA_Temozolomide_GDSC_TCGA_DNA_REPi_Expression_CNA.pt")
torch.save(
    Clas, 'Class_Temozolomide_GDSC_TCGA_DNA_REPi_Expression_CNA.pt')
