...
torch.save(AutoencoderE,
           "Exprs_Doxorubicin_GDSC_TCGA_DNA_REPi_Expression_CNA.pt")
torch.save(AutoencoderC,
           "CNA_Doxorubicin_GDSC_TCGA_DNA_REPi_Expression_CNA.pt")
torch.save(
    Clas, 'Class_Doxorubicin_GDSC_TCGA_DNA_REPi_Expression_CNA.pt')
