...
torch.save(AutoencoderE,
           "Exprs_Gemcitabine_GDSC_TCGA_DNA_REPi_Expression_CNA.pt")
torch.save(AutoencoderC,
           "CNA_Gemcitabine_GDSC_TCGA_DNA_REPi_Expression_CNA.pt")
torch.save(
    Clas, 'Class_Gemcitabine_GDSC_TCGA_DNA_REPi_Expression_CNA.pt')
