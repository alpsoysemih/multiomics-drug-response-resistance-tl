...
torch.save(AutoencoderE,
           "Exprs_Fluorouracil_GDSC_TCGA_DNA_REPi_Expression_CNA.pt")
torch.save(AutoencoderC,
           "Mut_Fluorouracil_GDSC_TCGA_DNA_REPi_Expression_CNA.pt")
torch.save(
    Clas, 'Class_Fluorouracil_GDSC_TCGA_DNA_REPi_Expression_CNA.pt')
