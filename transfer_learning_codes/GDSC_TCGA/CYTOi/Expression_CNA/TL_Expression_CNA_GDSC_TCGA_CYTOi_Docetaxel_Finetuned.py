...
save_models_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/CYTOi/save_models/GDSC_TCGA/Expression_CNA/"
save_finetuned_models_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/CYTOi/save_models/GDSC_TCGA/Expression_CNA/Finetuned_Models/"
save_results_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/CYTOi/save_models/GDSC_TCGA/Expression_CNA/AUC and Cost Plots (Finetuned)/"
...
# subset shared samples and genes in TCGA expression and CNA datasets (Docetaxel)
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCEv2.values, Y):
        ...
        AutoencoderE = torch.load(
            save_models_to + 'Exprs_Docetaxel_GDSC_TCGA_CYTOi_Expression_CNA.pt')
        AutoencoderC = torch.load(
            save_models_to + 'CNA_Docetaxel_GDSC_TCGA_CYTOi_Expression_CNA.pt')
        Clas = torch.load(
            save_models_to + 'Class_Docetaxel_GDSC_TCGA_CYTOi_Expression_CNA.pt')
        ...
        title = 'Cost Docetaxel iter = {}, fold = {}, mb_size = {},  h_dim[1,2] = ({},{}), \nlr[E,C] = ({}, {}), epoch = {}, rate[1,2,3] = ({},{},{}), wd = {}, lrCL = {}'.\
        ...
        title = 'AUC Docetaxel iter = {}, fold = {}, mb_size = {},  h_dim[1,2] = ({},{}), \nlr[E, C] = ({}, {}), epoch = {}, rate[1,2,3] = ({},{},{}), wd = {}, lrCL = {}'.\
            format(iters, k, mbs, hdm1, hdm2, lre, lrc,
                   epch, rate1, rate2, rate3, wd, lrCL)
    ...
    torch.save(AutoencoderE,
               f"Exprs_Docetaxel_GDSC_TCGA_CYTOi_Expression_CNA_Finetuned_{iters + 1}.pt")
    torch.save(
        AutoencoderC, f"CNA_Docetaxel_GDSC_TCGA_CYTOi_Expression_CNA_Finetuned_{iters + 1}.pt")
    torch.save(Clas, f'Class_Docetaxel_GDSC_TCGA_CYTOi_Expression_CNA_Finetuned_{iters + 1}.pt')
