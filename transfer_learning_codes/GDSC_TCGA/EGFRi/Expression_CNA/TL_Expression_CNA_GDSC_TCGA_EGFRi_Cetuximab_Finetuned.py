...
save_finetuned_models_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/EGFRi/save_models/GDSC_TCGA/Expression_CNA/Finetuned_Models/"
save_results_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/EGFRi/save_models/GDSC_TCGA/Expression_CNA/AUC and Cost Plots (Finetuned)/"
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCEv2.values, Y):
        ...
        AutoencoderE = torch.load(
            save_models_to + 'Exprs_Cetuximab_GDSC_TCGA_EGFRi_Expression_CNA.pt')
        AutoencoderC = torch.load(
            save_models_to + 'CNA_Cetuximab_GDSC_TCGA_EGFRi_Expression_CNA.pt')
        Clas = torch.load(
            save_models_to + 'Class_Cetuximab_GDSC_TCGA_EGFRi_Expression_CNA.pt')
    ...
    torch.save(AutoencoderE,
               f"Exprs_Cetuximab_GDSC_TCGA_EGFRi_Expression_CNA_Finetuned_{iters + 1}.pt")
    torch.save(
        AutoencoderC, f"CNA_Cetuximab_GDSC_TCGA_EGFRi_Expression_CNA_Finetuned_{iters + 1}.pt")
    torch.save(Clas, f'Class_Cetuximab_GDSC_TCGA_EGFRi_Expression_CNA_Finetuned_{iters + 1}.pt')
