...
save_results_to = "/arf/home/salpsoy/Thesis_Work/Results/GDSC_DEGs_inhibitors/EGFRi/save_models/GDSC_TCGA/Expression_Mutation/AUC and Cost Plots/"
...
# read diferentially expressed genes common in EGFRi signaling inhibitors
...
torch.save(
    AutoencoderE, "Exprs_Cetuximab_GDSC_TCGA_EGFRi_Expression_Mutation.pt")
torch.save(
    AutoencoderM, "Mut_Cetuximab_GDSC_TCGA_EGFRi_Expression_Mutation.pt")
torch.save(Clas, 'Class_Cetuximab_GDSC_TCGA_EGFRi_Expression_Mutation.pt')
